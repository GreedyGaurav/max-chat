...
export default function LandingPage() {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#fafafa]">
        <div className="relative h-10 w-10 sm:h-12 sm:w-12">
          ...
          <div className="absolute inset-0 animate-spin rounded-full border-2 border-t-blue-600 border-r-transparent border-b-transparent border-l-transparent"></div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#fafafa] selection:bg-blue-100 selection:text-blue-900">
      {/* Background Ornaments - Optimized for mobile performance */}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 sm:h-20 items-center justify-between">
            ...
            <Link
              ...
              className="inline-flex h-9 sm:h-11 items-center justify-center rounded-full bg-slate-900 px-4 sm:px-6 text-xs sm:text-sm font-semibold text-white transition-all hover:bg-slate-800 active:scale-95"
            >
      ...
      <main className="relative z-10 pt-24 sm:pt-32">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-12 sm:py-20 text-center">
          <div className="mb-6 sm:mb-10 inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50/50 px-3 py-1 sm:px-4 sm:py-1.5 text-[10px] sm:text-xs font-bold uppercase tracking-wider text-blue-700 backdrop-blur-sm">
          ...
          <h1 className="mb-6 text-4xl font-extrabold tracking-tight text-slate-900 sm:text-6xl lg:text-8xl px-2">
          ...
          <p className="mx-auto mb-10 max-w-2xl text-base sm:text-lg lg:text-xl leading-relaxed text-slate-500 font-medium px-4">
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
            ...
            <a
              href="#features"
              className="h-12 sm:h-14 px-8 flex items-center justify-center text-sm sm:text-lg font-semibold text-slate-600 hover:text-slate-900 transition-colors"
            >
              Explore features
            </a>
          </div>
        ...
        >
          <div className="mb-12 sm:mb-20 text-center">
            <h2 className="text-[10px] sm:text-sm font-bold uppercase tracking-[0.2em] text-blue-600 mb-3 sm:mb-4">
              Capabilities
            </h2>
            <h3 className="text-3xl font-bold text-slate-900 sm:text-5xl">
          ...
          <div className="grid gap-4 sm:gap-6 lg:gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={idx}
                className="group relative rounded-2xl sm:rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 transition-all hover:border-blue-200"
              >
                <div
                  className={`mb-4 sm:mb-6 flex h-10 w-10 sm:h-14 sm:w-14 items-center justify-center rounded-xl sm:rounded-2xl bg-${feature.color}-50 text-${feature.color}-600`}
                >
                  <svg
          ...
          <div className="relative overflow-hidden rounded-4xl sm:rounded-[3rem] bg-slate-900 px-6 py-16 sm:px-8 sm:py-20 text-center shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <p className="mx-auto mb-8 sm:mb-10 max-w-xl text-sm sm:text-lg text-slate-400 font-medium px-4">
                The cleanest Gemini client ever built. Free to use, forever
                secure.
              </p>
              <button
                onClick={handleCTAClick}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-slate-900 text-sm">Max Chat</span>
            </div>
            <p className="text-xs sm:text-sm font-medium text-slate-400 text-center">
              © 2025 Max Chat. Built with Next.js.
            </p>
            <div className="flex gap-4 sm:gap-6 text-xs sm:text-sm font-semibold text-slate-400">
